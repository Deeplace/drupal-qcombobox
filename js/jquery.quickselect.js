    ...
    // Set up all of the methods
      ...
      self.selectItem = function(li, from_hide_now_function){
        ...
        if(!from_hide_now_function)hideResultsNow(); // hide the results when something is selected
    		if(options.onItemSelect)setTimeout(function(){ options.onItemSelect(li, $input_element); }, 1); // run the user callback, if set
    		return true;
      };
...
$( "div.qcombobox input:hidden" ).livequery( function() {
      var hinput = $( this )
